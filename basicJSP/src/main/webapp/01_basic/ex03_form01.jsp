...
[1] form 태그 
	...
	(3) form 안에 있는 태그들의 속성 중에 name 속성과 value 로 값이 전달이된다 : name 변수이름 value 값  
...
--%>
	...
	<form action="./ex04_form02.jsp" method="get">
		이름 : <input type="text" name="myName" id="name" /> <br> 나이 : <input
			type="number" name="myAge" id="age" /> <br> 테스트1 <input
			type="radio" name="radio" value="테스트1" /> 테스트2 <input type="radio"
			name="radio" value="테스트2" />
